...
class CaioSamuel(Player):
    ...
    def temVencedor(self, tabuleiro):
        if((tabuleiro[0] == tabuleiro[1] == tabuleiro[2]) and (tabuleiro[0] != 0)):
            return True
        elif((tabuleiro[3] == tabuleiro[4] == tabuleiro[5]) and (tabuleiro[3] != 0)):
            return True
        elif((tabuleiro[6] == tabuleiro[7] == tabuleiro[8]) and (tabuleiro[6] != 0)):
            return True
        elif((tabuleiro[0] == tabuleiro[3] == tabuleiro[6]) and (tabuleiro[0] != 0)):
            return True
        elif((tabuleiro[1] == tabuleiro[4] == tabuleiro[7]) and (tabuleiro[1] != 0)):
            return True
        elif((tabuleiro[2] == tabuleiro[5] == tabuleiro[8]) and (tabuleiro[2] != 0)):
            return True
        elif((tabuleiro[0] == tabuleiro[4] == tabuleiro[8]) and (tabuleiro[0] != 0)):
            return True
        elif((tabuleiro[2] == tabuleiro[4] == tabuleiro[6]) and (tabuleiro[2] != 0)):
            return True
        else:
            return False
